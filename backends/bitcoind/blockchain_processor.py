...
class BlockchainProcessor(Processor):
    ...
    def __init__(self, config, shared):
        ...
        while True:
            try:
                ...
                print_log('cannot contact the coind...')
                time.sleep(5)
                continue
    ...
    def bitcoind(self, method, params=[]):
        ...
        try:
            ...
            print_log("error calling the coind")
    ...
    def getfullblock(self, block_hash):
        ...
        try:
            ...
            print_log("coind error (getfullblock)")
            traceback.print_exc(file=sys.stdout)
            self.shared.stop()
        ...
        for ir in r:
            if ir['error'] is not None:
                self.shared.stop()
                print_log("Error: make sure you run the coind with txindex=1; use -reindex if needed.")
